...
var createFile = function(userid, fileid, sha256, name, password, count) {
...
return Fabric_Client.newDefaultKeyValueStore({ path: store_path
	...
	var request = {
		...
		chaincodeId: 'fabcar',
		fcn: 'createFile',
		args: [userid, fileid, sha256, name, password, count],
		chainId: 'mychannel',
		txId: tx_id
	};
...
var transferFile = function(userid, transferto, fileid, count) {
...
return Fabric_Client.newDefaultKeyValueStore({ path: store_path
	...
	var request = {
		chaincodeId: 'fabcar',
		fcn: 'transferFile',
		args: [userid, transferto, fileid, count],
		chainId: 'mychannel',
		txId: tx_id
	};
